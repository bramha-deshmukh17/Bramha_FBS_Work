...
abstract class Defence {
	...
	public String toString() {
        return "No. of troops: " + no_of_troops + " No. of dept: " + no_of_dept + " No. of vehicle: " + no_of_vehicle
                + " Man PowerCount: " + manPowerCount + " No of casulaties: " + no_of_casulaties
                + " No of mission: " + no_of_mission + " Budget: " + budget + " Location Of Headquater: "
                + locationOfHeadquater + " Country Count: " + countryCount + " Name Of Head: " + nameOfHead;
    }
...
class Army extends Defence {
	...
	public String toString() {
        return super.toString() + " No. of tanks: " + no_of_tanks + " No. of guns: " + no_of_guns + " No. of grrenade: " + no_of_grrenade + " No. of batalin: " + no_of_batalin;
    }
...
class Navy extends Defence {
	...
	public String toString() {
        return super.toString() + " No. of ships: " + no_of_ships + " No. of submarine: " + no_of_submarine + " No. of torpedo: " + no_of_torpedo;
    }
...
class AirForce extends Defence {
	...
	public String toString() {
        return super.toString() + " No. of missiles: " + no_of_missiles + " No. of aircrafet: " + no_of_aircrafet + " No. of sqadron: " + no_of_sqadron;
    }
...
class DefenceDemo {
    public static void main(String[] args) {
        ...
        d = new Army(800000, 7, 4500, 650000, 300, 120, 4500000.0, "New Delhi", "35", "Gen. Rao",
                3500, 500000, 200000, 60);
        System.out.println(d.toString());
        d.attack();

        d = new Navy(250000, 3, 1200, 200000, 100, 60, 1800000.0, "Mumbai", "35", "Adm. Singh",
                150, 20, 300);
        System.out.println(d);
        d.attack();

        d = new AirForce(300000, 4, 1500, 250000, 120, 80, 2200000.0, "Bengaluru", "35", "ACM Kumar",
                500, 200, 30);
        System.out.println(d.toString());
        d.attack();
    }
