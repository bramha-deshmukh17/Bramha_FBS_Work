...
abstract class Artist {
    ...
    public String toString() {
        return "\nArtist Name: " + name + " Age: " + age + " Genre: " + genre + " Years of Experience: " + yearsExperience;
    }
...
class Painter extends Artist {
    ...
    public String toString() {
        return super.toString() + " Favorite Medium: " + favoriteMedium + " Signature Style: " + signatureStyle;
    }
...
class Musician extends Artist {
    ...
    public String toString() {
        return super.toString() + " Instrument: " + instrument + " Band: " + band;
    }
...
class Singer extends Artist {
    ...
    public String toString() {
        return super.toString() + " Vocal Range: " + vocalRange + " Number of Albums: " + numberOfAlbums;
    }
